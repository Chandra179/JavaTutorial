...
public class BankStatementProcessor {
	...
	public double calculateTotalInDay(final DayOfWeek week) {
		return summarizeTransactions((acc, bankTransaction) -> bankTransaction.getDate().getDayOfWeek() == week
				? acc + bankTransaction.getAmount()
				: acc);
	}
	...
	public List<BankTransaction> findTransactions(final BankTransactionFilter bankTransactionFilter) {
		...
		// return
		// bankTransactions.stream().filter(bankTransactionFilter).collect(Collectors.toList());
